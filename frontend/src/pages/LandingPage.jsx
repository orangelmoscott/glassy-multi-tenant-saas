            ...
            <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto mt-12">
                ...
                <div className="p-8 rounded-3xl border border-slate-100 bg-slate-50 flex flex-col text-left hover:shadow-lg transition-all">
                    ...
                    <ul className="space-y-4 mb-8 flex-1 text-slate-600 text-sm">
                        ...
                        <li className="flex items-start gap-2"><CheckCircle size={18} className="text-blue-500 shrink-0 mt-0.5"/> <span>Rutas con Mapa y Optimización</span></li>
                ...
                <div className="p-8 rounded-3xl border border-slate-100 bg-slate-50 flex flex-col text-left hover:shadow-lg transition-all">
                    ...
                    <ul className="space-y-4 mb-8 flex-1 text-slate-600 text-sm">
                        ...
                        <li className="flex items-start gap-2"><CheckCircle size={18} className="text-slate-800 shrink-0 mt-0.5"/> <span><strong className="text-slate-800">Mapa Logístico Avanzado</strong></span></li>
                        ...
                        <li className="flex items-start gap-2"><CheckCircle size={18} className="text-slate-800 shrink-0 mt-0.5"/> <span>Facturación y Dashboard Adicional</span></li>
