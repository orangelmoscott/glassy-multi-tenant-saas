                        ...
                        <AnimatePresence>
                            {filteredClients.map((client) => (
                                ...
                                >
                                    ...
                                    <button className="w-full mt-6 py-2.5 rounded-xl border border-slate-100 font-bold text-sm text-slate-600 group-hover:bg-slate-900 group-hover:text-white group-hover:border-slate-900 transition-all flex items-center justify-center gap-2">
                                        <FileText size={16} /> Ver Hoja de Servicio
                                    </button>
                                </motion.div>
                            ))}
                        </AnimatePresence>
